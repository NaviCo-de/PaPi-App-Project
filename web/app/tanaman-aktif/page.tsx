...
export default function TanamanAktifPage() {
  ...
  return (
    <div className="min-h-screen max-w-md mx-auto bg-white">
      ...
      <div className="bg-[#658100] px-6 py-4 flex items-center">
        ...
        <h1 className="text-lg font-semibold text-white">Tanaman Aktif</h1>
      </div>
      ...
      <div className="p-6 space-y-4">
        ...
        <div>
          <label className="block text-sm font-medium text-gray-700 mb-2">Jumlah Tanaman yang Sudah Ditanamkan</label>
          <input
            type="text"
        ...
        <div>
          <label className="block text-sm font-medium text-gray-700 mb-2">Tanggal Tanam</label>
          <input
            type="date"
        ...
        <div>
          <label className="block text-sm font-medium text-gray-700 mb-2">Pupuk</label>
          <input
            type="text"
            placeholder="Pupuk"
        ...
        <div>
          <label className="block text-sm font-medium text-gray-700 mb-2">Waktu Penyiraman Terakhir</label>
          <input
            type="text"
